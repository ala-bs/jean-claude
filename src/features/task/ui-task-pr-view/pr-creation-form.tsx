      ...
      {images.map((image, index) => (
        <div key={`${image.filename ?? 'img'}-${index}`} className="group relative">
          ...
          <button
            ...
            className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center bg-scrim-strong text-chrome-fg rounded-full opacity-60 transition-opacity hover:opacity-100 focus-visible:opacity-100"
