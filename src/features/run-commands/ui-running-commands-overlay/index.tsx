          ...
          groups.map((group) => {
            ...
            return (
              <div key={group.projectId}>
                ...
                {isExpanded && (
                  <div className="border-glass-border ml-2 border-l pl-1.5">
                    {group.groups.map((item) => (
                      <button
                        ...
                        className="text-ink-2 hover:text-ink-1 hover:bg-glass-light flex w-full cursor-pointer items-center gap-2 rounded-md px-2 py-1.5 text-left disabled:opacity-60"
                      >
                        <Star
                          className={clsx(
                            'h-3 w-3 shrink-0',
