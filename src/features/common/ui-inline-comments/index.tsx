        ...
        >
          {previewUrls[index] ? (
            <img
              ...
              className="border-glass-border h-8 w-8 rounded border object-cover"
            />
          ) : (
            <div
          ...
          {image.sizeBytes && (
            <span className="bg-scrim-strong text-chrome-fg absolute right-0 bottom-0 left-0 rounded-b px-0.5 text-center font-mono text-[7px] leading-3">
          ...
          {onRemove && (
            <button
              ...
              className="bg-scrim-strong text-chrome-fg absolute -top-1 -right-1 flex h-3.5 w-3.5 items-center justify-center rounded-full opacity-60 transition-opacity hover:opacity-100 focus-visible:opacity-100"
            >
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          {submitLabel}
          <kbd className="bg-glass-medium rounded px-1 py-px font-mono text-[9px]">
            {'\u2318\u21B5'}
          </kbd>
        </button>
        {allowImages && (
